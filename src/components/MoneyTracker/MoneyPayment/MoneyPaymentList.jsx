...
function MoneyPaymentList({ payments = [], onEdit = () => {}, onDelete = () => {} }) {
  return (
    <div className="card expense-list-card">
      <div className="section-header">
        <h3>Payment History</h3>

        <span className="category-count">{payments.length} Payments</span>
      </div>
        ...
        <div className="category-grid">
          {payments.map((payment) => (
            ...
            >
              ...
              {payment.notes && <p className="expense-description">{payment.notes}</p>}
