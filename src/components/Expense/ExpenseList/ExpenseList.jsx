...
function ExpenseList({ expenses, onEdit, onDelete }) {
  ...
  const users = [...new Set(expenses.map((e) => e.full_name))];
  ...
  const filteredExpenses = expenses.filter((expense) => {
    ...
    return (
      ...
      (!userFilter || expense.full_name === userFilter) &&
      (!dateFilter || expense.date.substring(0, 10) === dateFilter) &&
      (!yearFilter || expenseYear === Number(yearFilter)) &&
    ...
    <div className="card expense-list-card">
      <div className="section-header">
        ...
        <div className="header-right">
          <span className="category-count">{filteredExpenses.length} Entries</span>

          <button className="filter-button" onClick={() => setShowFilterPanel(true)}>
            ☰ Filter
          </button>
        </div>
      </div>
        ...
        <>
          ...
          <div className="filter-drawer">
            ...
            <div className="filter-actions">
              ...
              <button className="apply-button" onClick={() => setShowFilterPanel(false)}>
                Apply
              </button>
            </div>
          </div>
            ...
            <div key={expense.id} className="category-card user-card">
              <div className="category-top">
                ...
                <div className="category-details">
                  ...
                  <p className="username-text">{expense.full_name || 'Unknown'}</p>
