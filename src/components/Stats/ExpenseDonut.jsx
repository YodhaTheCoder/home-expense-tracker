      ...
      <div className="donut-container" ref={donutRef}>
        <svg width="260" height="260" viewBox="0 0 260 260">
          {data.map((item, index) => {
            ...
            const path = createArc(130, 130, 95, 65, startAngle, endAngle);

            const isActive = selected !== null && selected.name === item.name;

            const faded = selected !== null && !isActive;
...
function createArc(cx, cy, outerRadius, innerRadius, startAngle, endAngle) {
